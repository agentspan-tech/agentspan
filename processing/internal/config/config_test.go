...
func setRequiredEnv(t *testing.T) {
	t.Helper()
	t.Setenv("DATABASE_URL", "postgres://user:pass@localhost/agentorbit?sslmode=disable")
...
func TestLoadProcessing_LLMConfig(t *testing.T) {
	setRequiredEnv(t)
	t.Setenv("PROCESSING_LLM_BASE_URL", "https://api.deepseek.com/v1")
	t.Setenv("PROCESSING_LLM_API_KEY", "sk-test")
	t.Setenv("PROCESSING_LLM_MODEL", "deepseek-chat")
