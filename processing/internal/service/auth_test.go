...
func TestAuthService_Register(t *testing.T) {
	...
	svc := service.NewAuthService(context.Background(), queries, pool, mailer, "test-jwt-secret", "test-hmac-secret", "cloud", 24*time.Hour)

	result, err := svc.Register(context.Background(), "test@example.com", "Test User", "Password1")
	if err != nil {
...
func TestAuthService_Register_DuplicateEmail(t *testing.T) {
	...
	_, err := svc.Register(context.Background(), "dup@example.com", "User 1", "Password1")
	if err != nil {
		t.Fatalf("first register failed: %v", err)
	}

	// Second registration with same email should return 409 error
	result, err := svc.Register(context.Background(), "dup@example.com", "User 2", "Password2")
	if err == nil {
...
func TestAuthService_Login(t *testing.T) {
	...
	result, err := svc.Register(ctx, "login@example.com", "Login User", "Password1")
	if err != nil {
		t.Fatalf("register failed: %v", err)
	}
...
func TestAuthService_Login_WrongPassword(t *testing.T) {
	...
	ctx := context.Background()
	result, err := svc.Register(ctx, "wrong@example.com", "Wrong User", "Password1")
	if err != nil {
		t.Fatalf("register failed: %v", err)
	}
...
func TestAuthService_Login_RateLimited(t *testing.T) {
	...
	ctx := context.Background()
	result, err := svc.Register(ctx, "rate@example.com", "Rate User", "Password1")
	if err != nil {
		t.Fatalf("register failed: %v", err)
	}
	_ = queries.SetUserEmailVerified(ctx, result.UserID)
...
func TestAuthService_VerifyEmail(t *testing.T) {
	...
	ctx := context.Background()
	result, err := svc.Register(ctx, "verify@example.com", "Verify User", "Password1")
	if err != nil {
		t.Fatalf("register failed: %v", err)
	}
...
func TestAuthService_ResetPassword(t *testing.T) {
	...
	ctx := context.Background()
	result, err := svc.Register(ctx, "reset@example.com", "Reset User", "Password1")
	if err != nil {
		t.Fatalf("register failed: %v", err)
	}
	_ = queries.SetUserEmailVerified(ctx, result.UserID)
	...
	// Request reset
	resetResult, err := svc.RequestPasswordReset(ctx, "reset@example.com")
	if err != nil {
...
func TestAuthService_ChangePassword(t *testing.T) {
	...
	ctx := context.Background()
	result, err := svc.Register(ctx, "change@example.com", "Change User", "Password1")
	if err != nil {
		t.Fatalf("register failed: %v", err)
	}
	_ = queries.SetUserEmailVerified(ctx, result.UserID)
...
func TestAuthService_Register_UserAndTokenAtomic(t *testing.T) {
	...
	result, err := svc.Register(ctx, "atomic@example.com", "Atomic User", "Password1")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestAuthService_VerifyEmail_AtomicCleanup(t *testing.T) {
	...
	result, err := svc.Register(ctx, "cleanup@example.com", "Cleanup User", "Password1")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestAuthService_SetupStatus(t *testing.T) {
	...
	svc := service.NewAuthService(context.Background(), queries, pool, mailer, "test-jwt-secret", "test-hmac-secret", "self_host", 24*time.Hour)
	...
	// Register first user
	_, err = svc.Register(ctx, "first@example.com", "First User", "Password1")
	if err != nil {
