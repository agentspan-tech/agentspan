...
Thank you for your interest in contributing to AgentSpan!

## Contributor License Agreement (CLA)

By submitting a pull request, you agree to the following:

1. You grant AgentSpan and its maintainers a perpetual, worldwide, non-exclusive, royalty-free, irrevocable license to use, reproduce, modify, sublicense, and distribute your contribution under any license, including proprietary licenses.
...
3. You understand that your contribution may be used in both the open source and commercial versions of AgentSpan.
...
If you discover a security vulnerability, **do not open a public issue**. Instead, email security@agentspan.dev (or your preferred contact). We will respond within 48 hours.
